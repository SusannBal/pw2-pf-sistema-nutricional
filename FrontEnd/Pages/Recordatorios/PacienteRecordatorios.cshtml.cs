    ...
    public class PacienteRecordatoriosModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            try
            {
                ...
                // Assuming your API has an endpoint to get reminders by IdPersona
                var recordatoriosResponse = await _httpClient.GetAsync($"api/Recordatorios?idPersona={PersonaId}");
