    ...
    public class PacientePlanesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            try
            {
                ...
                {
                    var planesResponse = await _httpClient.GetAsync($"api/PlanNutricional?idConsulta={consulta.IdConsulta}"); // Asumiendo que el API puede filtrar por IdConsulta
                ...
                PlanesNutricionales = allPlanes.DistinctBy(p => p.IdPlan).ToList(); // Eliminar duplicados si una consulta tiene varios planes

                // Relacionar planes con sus consultas
